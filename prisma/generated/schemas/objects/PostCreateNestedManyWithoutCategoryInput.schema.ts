...
export const PostCreateNestedManyWithoutCategoryInputObjectSchemaBase = z.union(
  [
    z
      .object({
        create: z
...
export const PostCreateNestedManyWithoutCategoryInputObjectSchema: z.ZodType<Prisma.PostCreateNestedManyWithoutCategoryInput> =
  PostCreateNestedManyWithoutCategoryInputObjectSchemaBase;
