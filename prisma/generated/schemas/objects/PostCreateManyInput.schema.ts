...
export const PostCreateManyInputObjectSchemaBase = z
  .object({
  ...
  .strict();
export const PostCreateManyInputObjectSchema: z.ZodType<Prisma.PostCreateManyInput> =
  PostCreateManyInputObjectSchemaBase;
