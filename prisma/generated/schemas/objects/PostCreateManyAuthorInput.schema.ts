...
export const PostCreateManyAuthorInputObjectSchemaBase = z
  .object({
  ...
  .strict();
export const PostCreateManyAuthorInputObjectSchema: z.ZodType<Prisma.PostCreateManyAuthorInput> =
  PostCreateManyAuthorInputObjectSchemaBase;
