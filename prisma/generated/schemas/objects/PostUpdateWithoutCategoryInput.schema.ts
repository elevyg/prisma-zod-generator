...
export const PostUpdateWithoutCategoryInputObjectSchemaBase = z
  .object({
    id: z
      .union([
        z.string(),
  ...
  .strict();
export const PostUpdateWithoutCategoryInputObjectSchema: z.ZodType<Prisma.PostUpdateWithoutCategoryInput> =
  PostUpdateWithoutCategoryInputObjectSchemaBase;
